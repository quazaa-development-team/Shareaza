...
{
	//{{AFX_DATA_INIT(CIRCSettingsPage)
	//}}AFX_DATA_INIT
}
...
BOOL CIRCSettingsPage::OnInitDialog()
{
	...
	m_bShow	= Settings.IRC.Show;
	m_bTimestamp = Settings.IRC.Timestamp;
	m_bFloodEnable = Settings.IRC.FloodEnable;
...
{
	Settings.IRC.Show		 = m_bShow;
	Settings.IRC.FloodEnable = m_bFloodEnable;
	...
	Settings.IRC.Timestamp	 = m_bTimestamp;
