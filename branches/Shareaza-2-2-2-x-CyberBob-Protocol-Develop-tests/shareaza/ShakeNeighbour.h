...
public:
	...
	virtual BOOL ConnectTo(IN_ADDR* pAddress, WORD nPort, BOOL bAutomatic = FALSE, BOOL bNoUltraPeer = FALSE, BOOL bFirewallTest = FALSE); // Connect to an ip address and port number
