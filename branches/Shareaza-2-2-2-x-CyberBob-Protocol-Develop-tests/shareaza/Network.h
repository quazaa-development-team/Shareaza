...
public:
	...
	BOOL		IsStable() const;
	TRISTATE	IsFirewalled(int nCheck);
...
public:
	...
	void		Disconnect();
	BOOL		ConnectTo(LPCTSTR pszAddress, int nPort = 0, PROTOCOLID nProtocol = PROTOCOL_NULL, BOOL bNoUltraPeer = FALSE, BOOL bUDP = FALSE);
